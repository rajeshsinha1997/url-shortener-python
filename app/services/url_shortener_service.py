...
class UrlShortenerServiceImpl(IUrlShortenerService):
    """
    Implementation class for URL shortener service interface.

    This class implements the functionality of the URL shortener service interface.
    It provides methods to generate shortened URLs from long URLs and manage URL records.
    """
    ...
    def __generate_shortened_url(self, length: int) -> str:
        """
    ...
    def create_short_url_from_long_url(self, long_url: str) -> str:
        ...
        __existing_short_url: str | None = \
            self.url_shortener_repository.find_short_url_value_by_long_url_hash(
        ...
        __short_url_length: str | None = os.environ.get(
            'SHORT_URL_STRING_LENGTH')
        ...
        __shortened_url: str = self.__generate_shortened_url(
        ...
        self.url_shortener_repository.add_shortened_url_record(record_to_add=UrlData(
            params={
